...
rules based on the inport and outport numbers and the original tag
value.
...
hosts\footnote{Using TTL has other problems as well, see \S\ref{sec:implemenation}}, so a
