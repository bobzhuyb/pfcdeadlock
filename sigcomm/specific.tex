...
\para{Expected Lossless routes (ELR):} This is a set of routes that network
...
%comment: do we need to mention in challenges that we need to work with existing hardware?
%         I like it. i think we should mention.
