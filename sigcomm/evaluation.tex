...
\begin{table}[t]
	...
	\scalebox{0.85}{
		\begin{tabular}{|r|r|r|r|r|}
			...
			500 & 64 & 6 & 4 &  107\\
			\hline
			1,000 & 64 & 7 & 5 & to be added \\
			\hline
			2,000 & 64 & 7 & 5 &  to be added\\
			\hline
...
\begin{table}[t]
	...
	\scalebox{0.83}{
		\begin{tabular}{|r|r|r|r|r|}
			\hline
			\multicolumn{1}{|c|}{\tabincell{c}{\text{k (switch} \\ \text{port $\#$)}}} &  \multicolumn{1}{c|}{\tabincell{c}{\text{Network} \\ \text{diameter}}}    &	\multicolumn{1}{c|}{\tabincell{c}{\text{$\#$ of lossless} \\ \text{priority classes}}}   &    
			\multicolumn{1}{c|}{\tabincell{c}{Max \text{$\#$ of rules at} \\
					\text{a switch}}}\\
			\hline
			\hline
