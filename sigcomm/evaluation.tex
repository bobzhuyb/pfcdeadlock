...
\begin{table}[t]
	...
	\caption{Jellyfish with m shortest paths between each server pair (the result in the table is under the  settting of	switch number=50, switch port number = 32).}
