...
(Figure~\ref{fig:deadlock_example}). Circular Buffer Dependency (CBD) is a
necessary condition for deadlock formation, and thus, deadlock avoidance schemes
focus on avoiding CBD.  We now describe the three key challenges that any
