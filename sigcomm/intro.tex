...
%comment: I am trying to provide insight, with explanation. 
% shall we call it ELR or ELP, expected lossless path? 
...
%deadlock under any failure condition. 
Once the tag match-action rules are generated for the switches, \sysname{} can 
