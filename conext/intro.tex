...
of priority transition (\S\ref{sec:implementation}). \shuihai{Our simulations and experiments show that \sysname{} has negligible performance penalty on RDMA traffic.}
