...
\textcolor{blue}{
\subsection{The interplay of routing, deadlock, and lossless}}

\textcolor{blue}{Our prerequisite in this work is that our design needs to be deadlock-free and it needs to work with all existing routing, including all the distributed protocols, e.g., BGP and OSPF. Switches running distributed routing protocols need to react failures locally, hence routing loops and CBDs are unavoidable. Therefore distributed routing, deadlock-free, lossless cannot coexist at the same time.}
