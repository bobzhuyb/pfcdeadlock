...
\textcolor{blue}{Our prerequisite that our design needs to be deadlock-free and that it needs to work with all existing routing, including all the widely used protocols, e.g., BGP and OSPF poses technical challenge. Switches running distributed routing protocols need to react failures locally, hence routing loops and CBDs are unavoidable. Therefore distributed routing, deadlock-free, lossless cannot coexist at the same time.}
